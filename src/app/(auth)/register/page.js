...
function MotifAdinkra({ className, color = "#fff" }) {
  return (
    ...
    >
      ...
      <rect width="240" height="240" fill="url(#adinkraInscription)" />
    </svg>
  );
}
...
export default function InscriptionPage() {
  ...
  } = useForm({ resolver: yupResolver(inscriptionSchema) });
